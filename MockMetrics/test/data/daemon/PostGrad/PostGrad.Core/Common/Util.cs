...
namespace PostGrad.Core.Common
{
    ...
    public static class Util
    {
        ...
        /// <exception cref="BaseException">Невозможно получить имя свойства. Переданно выражение неверное типа.</exception>
        public static string GetPropertyName<TProperty>(Expression<Func<TProperty>> property)
        {
            ...
            {
                throw new BaseException("Невозможно получить имя свойства. Переданно выражение неверное типа.", ex);
            }
        }
