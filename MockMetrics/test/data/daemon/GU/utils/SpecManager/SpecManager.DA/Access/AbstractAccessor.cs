...
namespace SpecManager.DA.Access
{
    /// <summary>
    ...
    public abstract class AbstractAccessor<T> : DataAccessor<T>, IDomainObjectAccessor
    {
        ...
        {
            return (IDomainObject)this._query.SelectByKey(this.GetDbManager(), key);
        }

        public object Insert(IDomainObject obj)
        {
            return Query<T>.InsertWithIdentity(DataContextInfo.Create(this.GetDbManager()), (T)obj);
        }

        public object Update(IDomainObject obj)
        {
            return Query<T>.Update(DataContextInfo.Create(this.GetDbManager()), (T)obj);
        }

        public object InsertOrUpdate(IDomainObject obj)
        {
            return Query<T>.InsertOrReplace(DataContextInfo.Create(this.GetDbManager()), (T)obj);
        }

        public void Delete(IDomainObject obj)
        {
            Query<T>.Delete(DataContextInfo.Create(this.GetDbManager()), (T)obj);
        }

        public void DeleteByKey(object key)
        {
            this._query.DeleteByKey(this.GetDbManager(), key);
        }
