...
{
    public class ClaimRegistrReport : DbReport
    {
        private readonly string _username;
        private readonly DateTime _startDate;
        private readonly DateTime _endDate;

        public ClaimRegistrReport(string username, DateTime startDate, DateTime endDate, IDomainContext domainContext)
            : base(domainContext)
        {
            this._username = username;
            this._startDate = startDate;
            this._endDate = endDate;
            ViewPath = "Reporting/View/GU.HQ/ClaimRegistrReport.mrt";
        }
