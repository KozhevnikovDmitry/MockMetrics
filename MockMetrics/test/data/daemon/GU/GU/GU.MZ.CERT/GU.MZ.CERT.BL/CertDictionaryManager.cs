...
{
    /// <summary>
    /// Класс, предназначенный для хранения справочных данных схемы gu_mz_cert
    /// </summary>
    public class CertDictionaryManager : AbstractDictionaryManager
    {
        /// <summary>
        ...
        public CertDictionaryManager(IDomainDbManager dbManager)
        {
            try
            {
