...
{
    /// <summary>
    /// Класс, предназначенный для управления пользовательскими настройками приложения Archive.
    /// </summary>
    public class ArchiveUserPreferences : IUserPreferences
    {
        /// <summary>
        /// Класс, предназначенный для управления пользовательскими настройками приложения Archive.
        /// </summary>
        public ArchiveUserPreferences()
        {
            _configDirectoryPath = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)
                                   + "\\GU.Archive";
            _сonfigurationPath = _configDirectoryPath + "\\ArchiveConfig.xml";
            LoadSettings();
        }
    ...
    /// <summary>
    /// Класс, предназначенный для хранения пользовательских настроек приложения Archive.
    /// </summary>
    [Serializable]
