...
{
    public class InspectionOrderDataVm : SmartValidateableVm<InspectionOrder>
    {
        public override void Initialize(InspectionOrder entity)
        {
            if (Entity != null)
            {
        ...
        public string OrderName
        {
            get
            {
                return "Приказ о преведении выездной проверки";
            }
        }
