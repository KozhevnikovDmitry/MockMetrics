...
{
    public class InspectionOrderAgreeListVm : SmartListVm<InspectionOrderAgree>
    {
        private readonly IDialogUiFactory _uiFactory;
        private readonly AddOrderAgreeVm _addOrderAgreeVm;

        public InspectionOrderAgreeListVm(IDialogUiFactory uiFactory, AddOrderAgreeVm addOrderAgreeVm)
        {
