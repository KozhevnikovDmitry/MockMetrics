...
{
    /// <summary>
    /// Класс ViewModel для окна поиска лицензионных дел
    /// </summary>
    public class LicenseDossierSearchVm : AbstractSearchVM<LicenseDossier>
    {
        /// <summary>
        ...
        public LicenseDossierSearchVm(ISearchStrategy<LicenseDossier> strategy, IDomainDataMapper<LicenseDossier> dataMapper, SearchSpecificationContainer searchPresetContainer)
