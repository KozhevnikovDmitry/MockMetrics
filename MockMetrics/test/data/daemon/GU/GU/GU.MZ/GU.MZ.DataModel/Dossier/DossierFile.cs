...
namespace GU.MZ.DataModel.Dossier
{
    ...
    [SearchClass("Том лицензионного дела")]
    public abstract partial class DossierFile : IdentityDomainObject<DossierFile>, IPersistentObject
    {
        ...
        /// </summary>
        [MapField("reg_number")]
        [SearchField("Регистрационный номер тома", SearchTypeSpec.Number)]
        ...
        /// </summary>
        [MapField("task_id")]
        [SearchField("Номер заявки", SearchTypeSpec.Number)]
        ...
        [SearchField("Ответсвенный исполнитель", SearchTypeSpec.Dictionary)]
