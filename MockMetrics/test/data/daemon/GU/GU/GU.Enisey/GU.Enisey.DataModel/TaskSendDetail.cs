...
{
    [TableName("gu_enisey.task_send_det")]
    public abstract class TaskSendDetail : IdentityDomainObject<TaskSendDetail>, IPersistentObject
    {
        [PrimaryKey, Identity]
        [SequenceName("gu_enisey.task_send_det_seq")]
        [MapField("task_send_det_id")]
        public abstract override int Id { get; set; }

        [MapField("task_send_id")]
        public abstract int TaskSendId { get; set; }
