...
{
    [TableName("gu_enisey.task_state_send")]
    public abstract class TaskStateSend : IdentityDomainObject<TaskStateSend>, IPersistentObject
    {
        [PrimaryKey, Identity]
        [SequenceName("gu_enisey.task_state_send_seq")]
        [MapField("task_state_send_id")]
        public abstract override int Id { get; set; }

        [MapField("task_status_id")]
        public abstract int TaskStateId { get; set; }
