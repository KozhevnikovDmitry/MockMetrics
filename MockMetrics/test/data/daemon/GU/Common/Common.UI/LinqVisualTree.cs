...
namespace Common.UI
{
    ...
    public static class EnumerableTreeExtensions
    {
        ...
        /// </summary>
        public static IEnumerable<DependencyObject> DrillDown<T>(this IEnumerable<DependencyObject> items, Func<DependencyObject, IEnumerable<T>> function)
        ...
        public static IEnumerable<DependencyObject> 
            ...
            where T : DependencyObject
        {
            return items.DrillDown<T>(i => i.Descendants().Cast<T>());
        }
		...
		DescendantsAndSelf<T>(this IEnumerable<DependencyObject> items)
            where T : DependencyObject
        {
            return items.DrillDown<T>(i => i.DescendantsAndSelf().Cast<T>());
        }
        ...
        public static IEnumerable<DependencyObject> 
            ...
            where T : DependencyObject
        {
            return items.DrillDown<T>(i => i.Ancestors().Cast<T>());
        }
        ...
        public static IEnumerable<DependencyObject> 
            ...
            where T : DependencyObject
        {
            return items.DrillDown<T>(i => i.AncestorsAndSelf().Cast<T>());
        }
        ...
        public static IEnumerable<DependencyObject> 
            ...
            where T : DependencyObject
        {
            return items.DrillDown<T>(i => i.Elements().Cast<T>());
        }
        ...
        public static IEnumerable<DependencyObject> 
            ...
            where T : DependencyObject
        {
            return items.DrillDown<T>(i => i.ElementsAndSelf().Cast<T>());
        }
